...
class Dev404Page extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return this.state.showCustom404 ? this.props.custom404 : (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("h1", null, "Gatsby.js development 404 page"), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, "There's not a page or function yet at", ` `, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("code", null, pathname)), this.props.custom404 ? (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
      onClick: this.showCustom404
    }, "Preview custom 404 page")) : (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, `A custom 404 page wasn't detected - if you would like to add one, create a component in your site directory at `, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("code", null, "src/pages/404.js"), "."), newFilePath && (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("h2", null, "Create a page at this url"), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, "Create a React.js component like the following in your site directory at", ` `, "\"", (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("code", null, newFilePath), "\"", ` `, "and then refresh to show the new page component you created."), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("pre", {
      style: {
    ...
    }, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("code", {
...
export default function Component () {
  return "Hello world"
    ...
    }))), newAPIPath && (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("h2", null, "Create an API function at this url"), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, "Create a javascript file like the following in your site directory at", ` `, "\"", (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("code", null, newAPIPath), "\"", ` `, "and refresh to execute the new API function you created."), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("pre", {
      style: {
        border: `1px solid lightgray`,
        padding: `8px`,
        maxWidth: `80ch`,
...
export default function API (req, res) {
  res.json({ hello: "world" })
    ...
    }))), this.state.initPagePaths.length > 0 && (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("hr", null), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", null, "If you were trying to reach another page or function, perhaps you can find it below."), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("h2", null, "Functions (", this.props.data.allSiteFunction.nodes.length, ")"), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("ul", null, this.props.data.allSiteFunction.nodes.map(node => {
      const functionRoute = `/api/${node.functionRoute}`;
      return (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("li", {
        key: functionRoute
      }, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("a", {
        href: functionRoute
      }, functionRoute));
    })), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("h2", null, "Pages (", this.state.pagePaths.length != this.state.initPagePaths.length ? `${this.state.pagePaths.length}/${this.state.initPagePaths.length}` : this.state.initPagePaths.length, ")"), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("form", {
      onSubmit: this.handlePagePathSearch
    }, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("label", null, "Search:", (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("input", {
      type: "text",
      id: "search",
      placeholder: "Search pages...",
      value: this.state.pagePathSearchTerms,
      onChange: this.handleSearchTermChange
    })), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("input", {
      type: "submit",
      value: "Submit"
    })), (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("ul", null, this.state.pagePaths.map((pagePath, index) => index < 100 && (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("li", {
      key: pagePath
    }, (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)(gatsby__WEBPACK_IMPORTED_MODULE_2__.Link, {
      to: pagePath
    }, pagePath))), this.state.pagePaths.length > 100 && (0,_emotion_core__WEBPACK_IMPORTED_MODULE_4__.jsx)("p", {
      style: {
        fontWeight: `bold`
      }
...
const StaticQuery = props => {
  ...
  return (0,_emotion_core__WEBPACK_IMPORTED_MODULE_6__.jsx)(StaticQueryContext.Consumer, null, staticQueryData => (0,_emotion_core__WEBPACK_IMPORTED_MODULE_6__.jsx)(StaticQueryDataRenderer, {
    data: data,
    query: query,
